...
<body>
    ...
    <div class="contenedor-logo">
        <img src="images/Imágenes/Logo.png" alt="Logo de Gamedom">
    </div>
            <a href="biblioteca.php" class="nav-item" data-text="biblioteca">Biblioteca</a>
            <span>|</span>
            <a href="comunidad.php" class="nav-item" data-text="comunidad">Comunidad</a>
            <span>|</span>
            <a href="premios.php" class="nav-item" data-text="premios">Premios</a>
            <span>|</span>
            <?php if (isset($_SESSION['usuario'])): ?>
                  <a href="perfil.php" class="nav-item" data-text="perfil">Perfil</a>
            <?php else: ?>
                  <a href="login.html" class="nav-item" data-text="login">Iniciar Sesión</a>
            <?php endif; ?>
        <span>|</span>
        <div class="dropdown">
...
<div class="container">
    ...
    <div class="slide">
    <div data-text="Destacados" class="destacados">Destacados</div>
        ...
        <div class="item" style="background-image: url(images/Juegos/Hundir\ la\ flota.jpg);">
                <div class="content">
                    ...
                    <div class="des" data-text="txthundirlaflota">¡Zarpa hacia la estrategia definitiva! Toma el mando de tu escuadrón naval, despliega tus barcos y desafía a oponentes en duelos épicos. ¿Podrás hundir su flota antes de que ellos hundan la tuya?</div>
                    <button data-text="Jugar" class="boton2">Jugar</button>
                </div>
        </div>
        <div class="item" style="background-image: url(images/Juegos/risk1.jpg);">
            <div class="content">
                <div class="name" data-text="Risk">Risk</div>
                <div class="des" data-text="txtRisk"> ¡Prepárate para una batalla legendaria! Tu misión es expandir tu imperio, conquistar territorios y enfrentarte a tus oponentes en un juego de estrategia. ¿Serás el líder que domine el mundo? </div>
                <button data-text="Jugar" class="boton2">Jugar</button>
            </div>
        </div>
        <div class="item" style="background-image: url(images/Imágenes/Test\ image\ 2.png);">
            <div class="content">
                <div class="name">Juego3</div>
    ...
    <div class="button">
        <button class="prev"><i class="fa-solid fa-arrow-left"></i><b><</b></button>
        <button class="next"><i class="fa-solid fa-arrow-right"></i><b>></b></button>
    </div>

</div>
<main>
    <aside class="filter-sidebar">
      <h3 data-text="filtrar">Filtrar Juegos</h3>
      <!-- Formulario GET para filtrar -->
      <form method="GET" action="index.php">
        <div class="filter-group">
          <label for="search" data-text="buscar">Buscar:</label>
          <input type="text" id="search" name="search" class="search-bar" data-text="buscarjuego"
        ...
        <button type="submit" data-text="btnfiltrar">Filtrar</button>
      </form>
    </aside>
