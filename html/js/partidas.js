  ...
  fetch("php/obtener_partidas.php")
    ...
    .then(partidas => {
      ...
      partidas.forEach(p => {
        ...
        const nombreRuta = p.nombre_juego.toLowerCase().replace(/\s+/g, '');
        ...
        div.innerHTML = `
          ...
          <a href="games/${nombreRuta}/index.html?partida_id=${p.partida_id}&usuario_id=${encodeURIComponent(usuario)}"
